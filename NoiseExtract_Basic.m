%% Use this function for computing 
% 1) test noise residuals for Phase SPN. Read the paper for more details by Kang et al., "Enhancing Source Camera Identification Performance With a
% Camera Reference Phase Sensor Pattern Noise", T-IFS 2012 and
% 2) Sensor reference Pattern for Enhanced SPN. Read the paper for more
% details by C. T. Li, "Source Camera Identification Using Enhanced Sensor
% Pattern Noise", T-IFS 2010
%%
function image_noise = NoiseExtract_Basic(Im,qmf,sigma,L)
