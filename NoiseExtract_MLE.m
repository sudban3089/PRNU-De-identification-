%% Use this function for computing MLE test noise residual
function image_noise = NoiseExtract_MLE(Im,qmf,sigma,L)
...
%% MLE SPN Normalization

wave_trans = bsxfun(@times, wave_trans, 1./sqrt(sum(wave_trans.^2, 2)));
